...
@Component({
  selector: 'app-wholeslide',
  templateUrl: './wholeslide.component.html',
  styleUrls: ['./wholeslide.component.scss']
})
export class WholeslideComponent implements OnInit {
  ...
  getDziData(){
    ...
    this.http.post(`${this.BASE_URL}/brain/wholeslide/retrievedata`, {
  ...
  onConfirm() {
    ...
    this.http.get(`${this.BASE_URL}/brain/dzi/status`, { headers: headers })
        .subscribe((res: any) => {
  ...
  onDetectClick(){
    ...
    this.http.post<any>(`${this.BASE_URL}/brain/detectwsl/`, {
                name: this.selectedSample,
      })
      .subscribe(
        (res) => {
